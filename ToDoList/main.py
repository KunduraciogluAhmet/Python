...
button = Button(frame, text= "ADD", font= "arial 20 bold", width= 6, bg= "#5a95ff", fg="#fff", bd=0.2, command=addTask)
...
Button(root, image=Delete_icon, bd=1, command=deleteTask).pack(side=BOTTOM, pady=13)
